...
import { getProfile, updateProfile, uploadProfile } from '../services/profile'
    ...
    if (user !== null) {
      if (formData) {
        ...
        try {
          ...
          notification.error({
            message: `Profile updated successfully ${error}`,
            duration: 3,
          })
        }
      }
            ...
            <div className='custom-tabs'>
              <div className='tabRow' onClick={() => handleTabClick('profile')}>
                <MdOutlineAccountCircle
                  ...
                  color={activeTab === 'profile' ? 'rgb(94, 94, 247)' : 'var(--whiteText)'}
                />
              ...
              <div className='tabRow' onClick={() => handleTabClick('pictures')}>
                <IoMdPhotos
                  ...
                  color={activeTab === 'pictures' ? 'rgb(94, 94, 247)' : 'var(--whiteText)'}
                />
              ...
              <div className='tabRow' onClick={() => handleTabClick('videos')}>
                <CiVideoOn
                  ...
                  size={20}
                  // style={{ marginLeft: '10px' }}
                  color={activeTab === 'videos' ? 'rgb(94, 94, 247)' : 'var(--whiteText)'}
                />
              ...
              <div className='tabRow' onClick={() => handleTabClick('reviews')}>
                <GoCodeReview
                  ...
                  // style={{ marginLeft: '10px' }}
                  color={activeTab === 'reviews' ? 'rgb(94, 94, 247)' : 'var(--whiteText)'}
                />
                  ...
                  <div className='avatar-section'>
                    <div className='address' style={{ position: 'relative' }}>
                      ...
                      {fileList.length >= 1 ? (
                        ...
                        >
                          <EyeOutlined size={10} style={{ color: 'white' }} />
                          <DeleteOutlined size={10} style={{ color: 'white' }} />
                        </div>
                      ) : null}
                    </div>
